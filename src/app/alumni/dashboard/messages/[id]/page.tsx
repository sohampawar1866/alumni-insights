    ...
    return (
      <div className="max-w-4xl mx-auto py-20 text-center space-y-6 font-sans">
        <div className="inline-block border-2 border-slate-900 bg-white p-8 rounded-2xl shadow-[5px_5px_0px_#0f172a] space-y-3">
          ...
          <p className="text-xs font-semibold text-slate-600">You can only chat on accepted or completed requests.</p>
          <Link href="/alumni/dashboard/requests" className="inline-block mt-4 text-xs font-bold uppercase tracking-wider text-white bg-slate-900 px-4 py-2 rounded-xl border-2 border-slate-900 hover:bg-slate-800 transition-colors shadow-[2px_2px_0px_#0f172a]">
            Return to Requests
          </Link>
        </div>
      </div>
