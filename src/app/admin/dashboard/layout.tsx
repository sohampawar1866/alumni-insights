        ...
        <div className="p-5 border-b-2 border-slate-900 bg-amber-400 flex items-center justify-between">
          <div className="min-w-0 pr-2 flex items-center gap-2.5">
            ...
            <div className="min-w-0">
              <h2 className="text-sm font-bold tracking-tight text-slate-900 font-heading truncate">Admin Control</h2>
              <p className="text-xs font-semibold text-slate-900/80 truncate">
                Platform Administration
              </p>
            </div>
          </div>
          <label htmlFor="admin-menu" className="md:hidden p-2.5 rounded-xl border-2 border-slate-900 bg-white text-slate-900 shadow-[2px_2px_0px_#0f172a] cursor-pointer">
